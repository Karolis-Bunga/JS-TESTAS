...
console.log("Vidutinė kaina:", getAveragePrice(products));
console.log("Pavadinimai:", getProductsNames(products));
console.log("Unikalios kategorijos:", getUniqueCategories(products));
